...
final class OnDataCycleRegistryGeneratorTest extends TestCase
{
	...
	public function testCompositePrimaryKey(): void
	{
		...
		$this->assertSame(CycleGeneratedField::ON_INSERT, $fields->get('tenant_id')->getGenerated());
		$this->assertSame(CycleGeneratedField::ON_INSERT, $fields->get('user_id')->getGenerated());
	}
	...
	public function testFirstOfManyThrowsUnsupportedFeature(): void
	{
		...
		$this->expectException(UnsupportedOnDataFeatureException::class);
	...
	public function testContainerResolvesGeneratorWithDataRegistry(): void
	{
		...
		try {
			...
			$generator = $container->get(OnDataCycleRegistryGenerator::class);

			$this->assertInstanceOf(OnDataCycleRegistryGenerator::class, $generator);
