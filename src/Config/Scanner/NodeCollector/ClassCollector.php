...
namespace ON\Config\Scanner\NodeCollector;

use ON\Config\Scanner\DefinitionFactory;
use ON\Config\Scanner\NameResolver;
use PhpParser\Node;
use PhpParser\NodeTraverser;
use PhpParser\NodeVisitorAbstract;
use ON\Config\Scanner\Exception\UndefinedClassException;
