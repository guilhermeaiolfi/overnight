...
use ON\Mapper\Conversion\FieldResolverDefinition;
...
/**
 * Fluent entry for map(): representations, mapper args, optional resolvers, structural target.
 *
...
final class MapBuilder
{
	public function __construct(
		...
		/** @var list<FieldResolverDefinition> */
		private readonly array $resolverDefinitions = [],
	) {
	}
	...
	public function resolver(string $resolverClass, mixed ...$args): self
	{
		return $this->clone(
			resolverDefinitions: [
				...$this->resolverDefinitions,
				new FieldResolverDefinition($resolverClass, $args),
			],
		);
	}
	...
	private function buildMappingContext(): MappingContext
	{
		$context = new MappingContext(
			...
			$this->mapperClass,
			$this->args,
			resolverDefinitions: $this->resolverDefinitions,
		);
	 ...
	 * @param list<FieldResolverDefinition>|null $resolverDefinitions
	 */
	private function clone(
		...
		?array $resolverDefinitions = null,
	): self {
		return new self(
			$this->source,
			$this->gateway,
